...
const ReduxTodo = () => {
    ...
    return (
        <div className="outer" style={{ textAlign: 'center' }}>
            ...
            {todos.map((todo) => (
                <div key={todo._id} style={{ textAlign: 'center', border: '1px solid black', backgroundColor: '#f5f5f5', margin:'10px 0px', padding: '15px' }}>
                    <p><strong>Name:</strong> {todo.name}</p>
                    <p><strong>Status:</strong> {todo.status}</p>
                    <p><strong>Description:</strong> {todo.description}</p><br/>
            ...
            <div>&lt;script&gt; const num = 10; &lt;&#x2F;script&gt;</div>
        </div>
    );
};
